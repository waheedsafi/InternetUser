...
Route::post('/register', [AuthController::class, 'register'])->middleware('check.access:permission=CreateUsers');

Route::get('/internet',[InternetUserController::class, 'index']);
Route::get('/groups',[GroupController::class,'index']);
Route::get('/user',[AuthController::class,'index']);
Route::put('/user/{id}', [AuthController::class, 'systemUsersUpdate'])->middleware('check.access:permission=UpdateSystemData');
Route::delete('/user/{id}', [AuthController::class, 'systemUsersDelete'])->middleware('check.access:permission=DeleteSystemData'); 
Route::post('/internet',[InternetUserController::class,'store'])->middleware('check.access:permission=AddSystemData'); 
 Route::put('/internet/{id}', [InternetUserController::class, 'update'])->middleware('check.access:permission=UpdateSystemData');
...
Route::delete('/internet/{id}',[InternetUserController::class,'destroy'])->middleware('check.access:permission=DeleteSystemData'); 
...
Route::put('/users/{id}/status', [InternetUserController::class,'updateStatus'])->middleware('check.access:permission=UpdateSystemData');
...
Route::post('/violation',[ViolationTypeController::class, 'store'])->middleware('check.access:permission=AddSystemData');
Route::delete('/violation/{id}', [ViolationTypeController::class,'destroy'])->middleware('check.access:permission=DeleteSystemData');
